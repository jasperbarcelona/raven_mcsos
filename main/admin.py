...
def fetch_batch_records():
    path = 'static/records/lgmc_upload(09.24.18).xlsx'
    cols = 10
...
def fetch_records():
    ...
    for row in range(rows-1):
        ...
        db.session.add(new_record_kinder)
        total_students += 1
    ...
    for row in range(rows-1):
        ...
        db.session.add(new_record_prekinder)
        total_students += 1
    ...
    for row in range(rows-1):
        ...
        db.session.add(new_record_nursery)
        total_students += 1
